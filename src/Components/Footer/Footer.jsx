      ...
      <div className="container py-5">
        <div className="row">
          <div className="col-md-3 underline-border">
            ...
            <p className='text-white mt-4 ms-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, recusandae at voluptas a earum autem mollitia doloremque? Exercitationem, sed sapiente reprehenderit</p>
